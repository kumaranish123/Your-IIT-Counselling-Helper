...
<body>
    <form method="post" action="dummytwo.php" style="display : inline; z-index : 10000;">
        ...
        <br>
        <input type="submit" onclick="updatedata()" value="Submit">
    </form>
...
<script>
    ...
    function update(glob) {
        ...
        d3.select('svg').selectAll("circle").data(glob).enter()
            .append('circle')
            .attr("cy", (d, i) => {
                return d.cy;
            })
